                        ...
                        <div class="product-info">
                            <div class="nav-main">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#accessories" role="tab">Capacity</a></li>
                                ...
                                <div class="pagination-container d-flex justify-content-center">
                                    <div class="pagination">
                                        ...
                                        <c:if test="${currentPage > 1}">
                                            <a href="productSearch?page=${currentPage - 1}&search=${requestScope.search}" class="prev">&lt;</a>
                                        </c:if>
                                        ...
                                        <c:forEach var="i" begin="1" end="${totalPages}">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="productSearch?page=${i}&search=${requestScope.search}">${i}</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>
                                        ...
                                        <c:if test="${currentPage < totalPages}">
                                            <a href="productSearch?page=${currentPage + 1}&search=${requestScope.search}" class="next">&gt;</a>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
